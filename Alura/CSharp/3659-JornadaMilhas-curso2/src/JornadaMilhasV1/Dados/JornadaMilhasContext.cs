...
public class JornadaMilhasContext: DbContext
{
    ...
    {
        // logica retirada pois ja estamos definindo o banco na classe fixture 
        // esta sobrescrevendo a configuração de caminho do banco
        // retirado por logica do projeto
